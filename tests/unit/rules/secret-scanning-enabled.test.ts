...
describe('security/secret-scanning-enabled', () => {
	beforeEach(disableNet);
	afterEach(restoreNet);

	test('reports no findings when secret scanning is enabled', async () => {
	...
	test('reports a finding when secret scanning is disabled', async () => {
		nock('https://api.github.com')
			.get('/repos/sheplu/Octolens')
