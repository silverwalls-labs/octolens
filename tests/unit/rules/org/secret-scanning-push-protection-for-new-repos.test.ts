...
test('reports no findings when push protection is enabled for new repos', passCase);
...
test('reports a finding when push protection is not enabled for new repos', findingCase);
