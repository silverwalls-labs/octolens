...
test('reports no findings when members cannot invite outside collaborators', passCase);
...
test('reports a finding when members can invite outside collaborators', findingCase);
