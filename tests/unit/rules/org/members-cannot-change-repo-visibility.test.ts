...
describe('org/members-cannot-change-repo-visibility', () => {
	beforeEach(disableNet);
	afterEach(restoreNet);

	test('reports no findings when members cannot change visibility', async () => {
	...
	test('reports a finding when members can change visibility', async () => {
		nock('https://api.github.com')
			.get(ENDPOINT)
